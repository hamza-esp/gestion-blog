...
/*
// Check if the user is logged in and has the role of an Administrator (role 0) or another allowed role (e.g., role 1)
$allowedRoles = ['0', '1']; // Add allowed role(s) to this array
if (!isset($_SESSION['role']) || !in_array($_SESSION['role'], $allowedRoles)) {
  // Redirect or show an error message
  header("Location: dashboard.php"); // Redirect to an unauthorized page
...
{
  $list = $commentC->listResearcher($_GET['researcher']);
}else{
  $list = $commentC->list();
}

if (isset($_GET['id'])) {
  $commentToEdit = $commentC->getcommentbyID($_GET['id']);
}
...
if (isset($_REQUEST['add']) || isset($_REQUEST['edit'])) {
      ...
      if (isset($_REQUEST['add'])) {
        $comment = new Comment(1, $_POST['idU'], $_POST['idA'], $_POST['comment']);
...
<td>
                              <a href="Comments.php?id=<?php echo $key['id']; ?>">
...
<td>
<a href="deleteComments.php?id=<?php echo $key['id']; ?>">
  ...
  <div class="form-group">
    ...
    <textarea required class="form-control" id="comment" name="comment" placeholder="Comment"
              maxlength="300"></textarea>
  </div>
  <div class="form-group">
    <label for="idU">User</label>
    <input required type="text" class="form-control" id="idU" placeholder="User" name="idU"
           value="">
  </div>

  <div class="form-group">
    <label for="idA">Article</label>
    <input required type="text" class="form-control" id="idA" placeholder="Article" name="idA"
           value="">
  </div>
      ...
      new Chart(document.getElementById("bar-chart-horizontal"), {
        ...
        data: {
          ...
          datasets: [{
            ...
            data: [<?php echo $commentC->countComment(); ?>]
          }]
        },
        options: {
          scales: {
