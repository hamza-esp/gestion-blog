...
{
  $list = $articleC->listResearcher($_GET['researcher']);
}else{
  $list = $articleC->list();
}

if (isset($_GET['id'])) {
  $eventToEdit = $articleC->getarticlebyID($_GET['id']);
}
...
if (isset($_REQUEST['add']) || isset($_REQUEST['edit'])) {
      ...
      $arctileC = new arctileC();

      if (isset($_REQUEST['add'])) {
        $article = new article(1, $_POST['title'], $_POST['content'], $_POST['authorId'], $_POST['createdAt']);

        $arctileC->ajouterarticle($article);


      } else if (isset($_REQUEST['edit'])) {
       $article = new article(1, $_POST['title'], $_POST['content'], $_POST['authorId'], $_POST['createdAt']);

      $arctileC->modifierarticle($article);
      }
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Auteur Dashboard</span>
      </a>
    </div>
...
<td>
                              <a href="Articles.php?id=<?php echo $key['id']; ?>">
...
<td>
<a href="deleteArticles.php?id=<?php echo $key['id']; ?>">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Formulaire article</h4>

                  <form class="forms-sample" action="" enctype="multipart/form-data" method="POST">
  <?php if (isset($eventToEdit)) { ?>
    <div class="form-group">
      <label for="id">ID</label>
      <input type="text" class="form-control" id="id" name="id" value="<?php echo $eventToEdit['id'] ?>" readonly>
    </div>
  <?php } ?>
  <div class="form-group">
    <label for="title">Title</label>
    <input required type="text" class="form-control" id="title" name="title" placeholder="Title"
           maxlength="50" value="<?php if (isset($eventToEdit)) echo $eventToEdit['title']; ?>">
  </div>
  <div class="form-group">
    <label for="content">Content</label>
    <textarea required class="form-control" id="content" name="content" placeholder="Content"
              maxlength="300"><?php if (isset($eventToEdit)) echo $eventToEdit['content']; ?></textarea>
  </div>
  <div class="form-group">
    <label for="authorId">Author</label>
    <input required type="text" class="form-control" id="authorId" placeholder="Author" name="authorId"
           value="<?php if (isset($eventToEdit)) echo $eventToEdit['authorId']; ?>">
  </div>

                    <div class="form-group">
  <label for="date">Date</label>
  <input required type="date" class="form-control" id="createdAt" name="createdAt"
      ...
      new Chart(document.getElementById("bar-chart-horizontal"), {
        ...
        data: {
          ...
          datasets: [{
            ...
            data: [<?php echo $articleC->countArticle(); ?>]
          }]
        },
        options: {
          scales: {
